...
export const meta = {
  id: "illustration-retrieval",
  version: 1,
  legacyAliases: ["illustrations.scene-retrieval"],
  ...
  schema: { properties: {
    ...
    sceneVariant: { type: "enum", values: ["retrieval"], default: "retrieval" },
...
export function mount(root, context = {}) {
  return mountIllustrationComponent(root, context, meta, "ir", { fixedSceneId: "retrieval" });
}
