...
Show up to four compact metric trends. The component contains no example data; callers must provide evidence and provenance.
...
Legacy alias: `broll-charts.sparkline`.
