...
Compare up to three aligned trends. The component contains no example data; callers must provide evidence and provenance.
...
Legacy alias: `broll-charts.multi-line`.
