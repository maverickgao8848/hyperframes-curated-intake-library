...
export const meta = {
  id: "illustration-thinking",
  version: 1,
  legacyAliases: ["illustrations.scene-thinking"],
  ...
  schema: { properties: {
    ...
    sceneVariant: { type: "enum", values: ["thinking"], default: "thinking" },
...
export function mount(root, context = {}) {
  return mountIllustrationComponent(root, context, meta, "it", { fixedSceneId: "thinking" });
}
