...
Compare discrete signed quantities. The component contains no example data; callers must provide evidence and provenance.
...
Legacy alias: `broll-charts.bar-chart`.
