...
Show intensity across two labeled dimensions. The component contains no example data; callers must provide evidence and provenance.
...
Legacy alias: `broll-charts.heatmap`.
