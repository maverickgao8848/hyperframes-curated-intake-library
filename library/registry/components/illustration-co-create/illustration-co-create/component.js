...
export const meta = {
  id: "illustration-co-create",
  version: 1,
  legacyAliases: ["illustrations.scene-co-create"],
  ...
  schema: { properties: {
    ...
    sceneVariant: { type: "enum", values: ["co-create"], default: "co-create" },
...
export function mount(root, context = {}) {
  return mountIllustrationComponent(root, context, meta, "ic", { fixedSceneId: "co-create" });
}
