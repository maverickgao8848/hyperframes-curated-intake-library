...
export const meta = {
  id: "illustration-launch",
  version: 1,
  legacyAliases: ["illustrations.scene-launch"],
  ...
  schema: { properties: {
    ...
    sceneVariant: { type: "enum", values: ["launch"], default: "launch" },
...
export function mount(root, context = {}) {
  return mountIllustrationComponent(root, context, meta, "il", { fixedSceneId: "launch" });
}
