...
Show one trend over an ordered domain. The component contains no example data; callers must provide evidence and provenance.
...
Legacy alias: `broll-charts.line-chart`.
