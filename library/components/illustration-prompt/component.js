...
export const meta = {
  ...
  version: 1,
  legacyAliases: ["illustrations.scene-prompt"],
  ...
  schema: { properties: {
    ...
    sceneVariant: { type: "enum", values: ["prompt"], default: "prompt" },
...
export function mount(root, context = {}) {
  return mountIllustrationComponent(root, context, meta, "ip", { fixedSceneId: "prompt" });
}
